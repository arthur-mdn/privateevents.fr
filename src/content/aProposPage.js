...
export const aProposMethod = {
  ...
  steps: [
    ...
    },
    {
      step: '02',
      title: 'Construction',
      description: 'Proposer une prestation cohérente : musique, technique, animations et options.',
    },
    {
      step: '03',
      title: 'Préparation',
      description: 'Playlist, planning, coordination et vérifications avant le jour J.',
    },
    {
      step: '04',
      title: 'Adaptation',
...
export const aProposPartners = {
  ...
  categories: [
    ...
    'Musiciens live',
    'Magiciens & mentalistes',
    'Décoration & mise en scène',
    'Garde d\'enfants & animations',

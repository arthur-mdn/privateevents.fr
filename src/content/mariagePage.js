...
export const mariagePromesse = {
  ...
  points: [
    ...
    },
    {
      ...
      description: 'Karaoké, photobooth, vidéobooth, musiciens live, effets visuels : une offre modulable selon votre budget.',
    },
  ],
};

export const mariageTimeline = [
  {
    step: '01',
...
export const mariageMoments = [
  {
    title: 'Cérémonie',
    description: 'Sonorisation discrète pour la cérémonie laïque ou religieuse, musique d\'entrée et de sortie.',
  ...
  },
  {
    ...
    description: 'Programmation sur mesure, jeux de lumières et gestion des temps forts jusqu\'au bout de la nuit.',
    image: '/elements/gallery/mariage-dansant-lumieres.jpg',
    imageAlt: 'Piste de danse animée lors d\'un mariage',
  },
];

export const mariageMusic = {
...
export const mariagePopularOptions = [
  {
...
export const mariageCaseStudy = {
  ...
  prestations: ['DJ & éclairage', 'Sonorisation cocktail', 'Ouverture de bal', 'Étincelles froides', 'Karaoké en fin de soirée'],
  outcome:
